          ...
          <Box sx={{ position: "relative", mb: { xs: 1, sm: 1.5 } }}>
            ...
            <Box
              sx={{
                ...
                top: { xs: 4, sm: 8 },
                right: { xs: 4, sm: 8 },
                bgcolor: offer.status === 'completed' ? "rgba(226, 232, 240, 0.9)" : "rgba(30, 30, 46, 0.9)",
                px: { xs: 0.5, sm: 1 },
                py: { xs: 0.25, sm: 0.5 },
                borderRadius: 10,
                display: "flex",
                ...
                <Box key={event.id} sx={{ position: "relative", pl: 4, pb: isLast ? 0 : 0 }}>
                  ...
                  <Box
                    sx={{
                      ...
                      p: 1.5,
                      bgcolor: isCompleted ? "rgba(226, 232, 240, 0.05)" : "#222339",
                      borderRadius: 2,
                      border: `1px solid ${isCompleted ? "rgba(226, 232, 240, 0.25)" : "rgba(255,255,255,0.05)"}`,
                      transition: "all 0.2s",
                      mb: 1,
                      "&:hover": {
                        borderColor: isCompleted ? "rgba(226, 232, 240, 0.4)" : "rgba(226, 232, 240, 0.3)",
                        bgcolor: isCompleted ? "rgba(226, 232, 240, 0.08)" : "#252640",
                      },
                    }}
                  >
                    <Box sx={{ display: "flex", alignItems: "center", gap: 1.5, flex: 1 }}>
                      ...
                      <Box
                        sx={{
                          ...
                          height: 20,
                          borderRadius: "50%",
                          border: `2px solid ${isCompleted ? "#E2E8F0" : "#3d3f54"}`,
                          bgcolor: isCompleted ? "#E2E8F0" : "#1a1b2e",
                          display: "flex",
                          alignItems: "center",
                          justifyContent: "center",
                          zIndex: 1,
                    ...
                    <Box sx={{ display: "flex", alignItems: "center", gap: 1.5, ml: 1 }}>
                      <Typography 
                        sx={{ 
                          fontSize: "0.8125rem", 
                          color: isCompleted ? "#E2E8F0" : "rgba(255,255,255,0.5)",
                          fontWeight: 700,
                        }}
                      >
                        +{event.payout} coins
